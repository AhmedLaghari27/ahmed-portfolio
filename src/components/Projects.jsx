...
const projects = [
  ...
  //   num: '03',
  //   title: 'CryptoVault',
  //   desc: 'Secure cryptocurrency portfolio tracker with live price feeds, portfolio analytics, DeFi protocol integration, and multi-wallet support.',
  //   techs: ['React', 'Web3.js', 'Redux', 'Firebase', 'CoinGecko API'],
  //   emoji: '🔐',
